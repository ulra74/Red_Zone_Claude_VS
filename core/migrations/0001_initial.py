# Generated by Django 5.2.4 on 2025-07-17 18:03
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('nombre_examen', models.CharField(help_text='Nombre del examen (conservado para el ranking)', max_length=200)),
                ('fecha_completado', models.DateTimeField(help_text='Fecha cuando se completó el examen')),
                ('tipo_examen', models.CharField(choices=[('normal', 'Normal'), ('examen', 'Examen')], default='normal', max_length=20)),
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('estudiante', models.ForeignKey(limit_choices_to={'user_type': 'student'}, on_delete=django.db.models.deletion.CASCADE, related_name='resultados_examenes', to=settings.AUTH_USER_MODEL)),
                ('examen', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resultado', to='core.examentest')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('oposiciones', models.ManyToManyField(blank=True, help_text='Oposiciones a las que pertenece este tema', related_name='temas', to='core.oposicion')),
            ],
            options={
                'ordering': ['orden', 'nombre'],
            },
        ...
        migrations.AddField(
            model_name='examentest',
            name='temas_seleccionados',
            field=models.ManyToManyField(help_text='Temas seleccionados para el examen', related_name='examenes_test_tema', to='core.tema'),
        ),
        migrations.AddField(
            model_name='examen',
            name='tema',
        ...
        migrations.AddField(
            model_name='apartado',
            name='tema',
            field=models.ForeignKey(help_text='Tema al que pertenece este apartado', on_delete=django.db.models.deletion.CASCADE, related_name='apartados', to='core.tema'),
        ),
        migrations.CreateModel(
            name='LogroUsuario',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fecha_inicio_tema', models.DateField(blank=True, help_text='Cuándo se empieza este tema', null=True)),
                ('fecha_fin_tema', models.DateField(blank=True, help_text='Cuándo se termina este tema', null=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('oposicion', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.oposicion')),
